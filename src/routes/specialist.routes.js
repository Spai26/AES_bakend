...
const { validatorRegisterSpecialist, validatorGetItems, validateUpdate } = require("../validators/Specilist")

const specialistRouter = Router();

specialistRouter.get("/", Controller.addSpecialist );
specialistRouter.get("/:id", validatorGetItems, Controller.detailSpecialistForid);
specialistRouter.post("/", validatorRegisterSpecialist, Controller.registerSpecialist );
specialistRouter.put("/:id", validateUpdate, Controller.specialistUpdate );
